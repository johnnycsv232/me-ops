...
def main():
    ...
    try:
        ...
        # 13. Workflow DNA
        print("\n[13/18] WORKFLOW DNA: Extracting process genetics...")
        ...
        # 14. Insights
        print("\n[14/18] INSIGHTS: Generating evolving connections...")
        ...
        # 15. Action x Site Insights
        print("\n[15/18] ACTION x SITE: Generating action-by-site insights...")
        action_site_payload = action_site_insights.run(
            db_path=db_path,
            con=con,
            output_dir=root_dir / "output",
        ...
        # 16. Daily Report
        print("\n[16/18] REPORTING: Generating detailed daily report...")
        daily_report.run(db_path, con=con, report_date=report_date)

        # 17. Briefing
        print("\n[17/18] BRIEFING: Preparing morning briefing...")
        brief_res = briefing.run(db_path, con=con, target_date=report_date, no_ai=(not args.ai))

        # 18. Dashboard Bridge
        print("\n[18/18] DASHBOARD: Exporting data bridge...")
        dashboard_bridge.run(db_path, con=con)
