...
def run(
    ...
    *,
    ...
    """Wrapper for generate_report supporting shared connection."""
    return generate_report(db_path, report_date=report_date, con=con)
...
if __name__ == "__main__":
    ...
    sys.exit(0 if generate_report(args.db, report_date=args.date) else 1)
